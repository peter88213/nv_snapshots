[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/nv_snapshots/raw/main/dist/nv_snapshots_v0.9.0.pyzw)
...
Download the latest release [nv_snapshots_v0.9.0.pyzw](https://github.com/peter88213/nv_snapshots/raw/main/dist/nv_snapshots_v0.9.0.pyzw)

- Launch *nv_snapshots_v0.9.0.pyzw* by double-clicking (Windows/Linux desktop),
- or execute `python nv_snapshots_v0.9.0.pyzw` (Windows), resp. `python3 nv_snapshots_v0.9.0.pyzw` (Linux) on the command line.
...
The package is also available in zip format: [nv_snapshots_v0.9.0.zip](https://github.com/peter88213/nv_snapshots/raw/main/dist/nv_snapshots_v0.9.0.zip)

- Extract the *nv_snapshots_v0.9.0* folder from the downloaded zipfile "nv_snapshots_v0.9.0.zip".
